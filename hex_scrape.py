...
def start_scanning():
    ...
    scan_button.click()
    time.sleep(1)
    random_line_button = driver.find_element("xpath", "//button[@name='author' and @value='randomLatin' and @type='submit' and @class='btn btn-default btn-block']")
    random_line_button.click()
    time.sleep(1)
